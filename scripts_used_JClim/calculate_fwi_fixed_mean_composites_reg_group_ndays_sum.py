...
for pp in range(0,nperiods,1):
	...
	events_char_pp_xx_xr.to_netcdf(dir_comps+'CESM2-LE_'+ens_string+'_p'+pxx_string+'_FWI_events_char_composites_'+period_str[pp]+'_fixed_'+reg_groups[gg]+'_'+seasons[ss]+'.nc')
	print('\n')
