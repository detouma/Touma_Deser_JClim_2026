...
dir_RH = '/glade/derecho/scratch/detouma/extreme_objects/RH_from_VP_mapped/mean_mapped/'
dir_VP = '/glade/derecho/scratch/detouma/extreme_objects/VP/mean_mapped/'
...
VP_file = 'CESM2-LE_'+T_ens_string+'_1980-2083_members_VP_mapped_to_1980_mean.nc'
...
RH_xr = xr.Dataset(
    ...
    attrs={'title': 'RHREFHT calcuated using mean mapped VP for CESM2LE_' + T_ens_string}
)

print('writing file', flush=True)
RH_xr.to_netcdf(dir_RH+'CESM2LE_RHREFHT_using_VP_mean_mapped_'+T_ens_string+'_'+str(year0)+'-'+str(year1)+'_NWHemi.nc')
