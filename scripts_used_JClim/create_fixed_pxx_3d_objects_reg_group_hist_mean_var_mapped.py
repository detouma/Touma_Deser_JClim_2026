...
xr_event.to_netcdf(dir_event+'CESM2-LE_'+ens_no_string[ens]+'_mean_mapped_'+var_name+'_to_'+str(n_ens_dist)+'ens_'+str(pxx_year)+'_p'+str(pxx)+'_FWI_event_numbers_'+str(year0)+'-'+str(year1)+'_'+reg_groups[gg]+'.nc')
