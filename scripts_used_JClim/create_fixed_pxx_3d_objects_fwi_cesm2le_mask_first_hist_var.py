...
xr_event.to_netcdf(dir_event+'CESM2-LE_'+ens_string[nn]+'_mapped_'+var_name+'_to_'+str(n_ens_dist)+'_ens_'+str(pxx_year)+'_p'+str(pxx)+'_FWI_event_numbers_'+str(year0)+'-'+str(year1)+'_NWHemi.nc')
