...
print('CESM2-LE_*_FWI_'+str(n_ens_dist)+'_ens_'+pxx_type+'_p'+pxx_string+'_3d_events_'+str(year0)+'-'+str(year1)+'_*_historic_'+hist_var+'_mean_VP.txt')
for file in sorted(glob.glob(dir_tables+'CESM2-LE_*_FWI_'+str(n_ens_dist)+'_ens_'+pxx_type+'_p'+pxx_string+'_3d_events_'+str(year0)+'-'+str(year1)+'_*_historic_'+hist_var+'_mean_VP.txt')):
...
# read in FWI
f_fwi = 'FWI_CESM2-LE_'+ens_string+'_historic_1980_mean_VP_mapped_RHREFHT_19800101-20821231.nc'
...
object_file = 'CESM2-LE_'+ens_string+'_mean_VP_mapped_'+hist_var+'_to_'+str(n_ens_dist)+'ens_'+str(pxx_year0)+'_p'+pxx_string+'_FWI_event_numbers_'+str(year0)+'-'+str(year1)+'_'+reg_groups[gg]+'.nc'
...
for pp in range(0,nperiods,1):
	...
	events_char_pp_xr.to_netcdf(dir_comps+'CESM2-LE_'+ens_string+'_mean_VP_mapped_'+hist_var+'_p'+pxx_string+'_FWI_events_char_composites_'+period_str[pp]+'_'+pxx_type+'_'+reg_groups[gg]+'_'+season+'.nc')
	print('\n')
