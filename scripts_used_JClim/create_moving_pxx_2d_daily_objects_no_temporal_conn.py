...
file_event = dir_event+'CESM2-LE_'+ens_string[nn]+'_allens_'+str(nyears_window)+'-year_moving_p'+str(pxx)+'_FWI_daily_2d_event_numbers_'+str(year0)+'-'+str(year1)+'_U10_NWHemi.nc'
