...
file_event = dir_event+'CESM2-LE_'+ens_string[nn]+'_allens_'+str(pxx_year)+'_p'+str(pxx)+'_FWI_event_numbers_'+str(year0)+'-'+str(year1)+'_U10_NWHemi.nc'
nc_event = Dataset(file_event,'w',format='NETCDF4')
nc_event.description = 'All ensembles (1-100) p'+str(pxx)+' Fire Weather Index exceedence event numbers. Masked oceans. SciPy functions used: label().' 
